...
destinations = {
    ...
    'fds': os.path.join("F:/", 'FC'),
    # Pending 'colecovision': os.path.join("F:/", 'FC'),
    'a26': os.path.join("F:/", 'GB'),
    '5200': os.path.join("F:/", 'GB'),
    # Pending 'lynx': os.path.join("F:/", 'GB'),
    # Pending 'intellivision': os.path.join("F:/", 'GB'),
    'gb': os.path.join("F:/", 'GBC'),
    'gbc': os.path.join("F:/", 'GBC'),
    'gba': os.path.join("F:/", 'GBC'),
    'pokem': os.path.join("F:/", 'GBC'),
    'neo': os.path.join("F:/", 'GBA'),
    # Pending 'wonderswan': os.path.join("F:/", 'GBA'),
    # Pending 'supervision': os.path.join("F:/", 'GBA'),
